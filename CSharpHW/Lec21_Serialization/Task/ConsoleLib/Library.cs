...
namespace ConsoleLib
{
    class Library
    {
        ...
        public void UploadBooks(SerializeType dataType)
        {
            Serializer.Serialize(Books, dataType, "books");
        }

        public void DownloadBooks(SerializeType dataType)
        {
            try
            {
                Books = Serializer.Deserialize(dataType, "books");
            }
            catch (Exception e)
            {
                WriteLine(e.Message);
